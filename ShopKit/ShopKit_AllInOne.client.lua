...
--======================================================================
local CONFIG = {
	realmName = "Fart to Float",           -- footer: "⭐ Thanks for supporting <realmName>!"
	...
	buildShopButton = true,                 -- false = realm's own sidebar opens PremiumShopGui itself
	shopButtonY     = 96,                   -- desktop rail slot 1 (grid is 96 / 203 / 310 / 417, pitch 107)
